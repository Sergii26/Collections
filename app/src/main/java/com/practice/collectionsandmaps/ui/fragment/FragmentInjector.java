...
import com.practice.collectionsandmaps.models.factories.CollectionsTasksFactory;
import com.practice.collectionsandmaps.models.factories.MapsTasksFactory;
...
public class FragmentInjector {
    static CalculationFragmentPresenter createPresenter(FragmentView view, int mode) {
        return new CalculationFragmentPresenter(view, FragmentsIndication.COLLECTION == mode ?
                new CollectionsTasksSupplier() : new MapsTasksSupplier(),
                FragmentsIndication.COLLECTION == mode ?
                new CollectionsTasksFactory() : new MapsTasksFactory(),
                FragmentsIndication.COLLECTION == mode ?
